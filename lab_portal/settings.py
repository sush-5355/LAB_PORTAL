"""
Django settings for lab_portal project.
...
SECRET_KEY = "django-insecure-)=uo^sv7u%1$vqr(*0xhy8&n^44@taoseu7!ho8ws)3-g=kcg="
...
#     'user_portal.authentication.EmailAuthBackend',  # Replace with your app name
